...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2018-03-06")
public class JsReferenceService {

  public interface Iface {

    public java.util.List<Section> getSections() throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getSections(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Section>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public java.util.List<Section> recv_getSections() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getSections_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Section>> {
      public getSections_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Section>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public java.util.List<Section> getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getSections<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getSections_args, java.util.List<Section>> {
      public getSections() {
        super("getSections");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<Section>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<Section>>() { 
          public void onComplete(java.util.List<Section> o) {
            getSections_result result = new getSections_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getSections_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Section>> resultHandler) throws org.apache.thrift.TException {
...
;
  ...
  public static class getSections_result implements org.apache.thrift.TBase<getSections_result, getSections_result._Fields>, java.io.Serializable, Cloneable, Comparable<getSections_result>   {
    ...
    public java.util.List<Section> success; // required
    ...
    public getSections_result(
      java.util.List<Section> success)
    {
      this();
    ...
    public getSections_result(getSections_result other) {
      if (other.isSetSuccess()) {
        java.util.List<Section> __this__success = new java.util.ArrayList<Section>(other.success.size());
        for (Section other_element : other.success) {
          __this__success.add(new Section(other_element));
        }
    ...
    public java.util.Iterator<Section> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(Section elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<Section>();
      }
      this.success.add(elem);
    }

    public java.util.List<Section> getSuccess() {
      return this.success;
    }

    public getSections_result setSuccess(java.util.List<Section> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<Section>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Section>(_list8.size);
                  Section _elem9;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getSections_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Section _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Section _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Section>(_list13.size);
            Section _elem14;
